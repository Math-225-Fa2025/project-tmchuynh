...
knitr::include_graphics("presentation_files/winrate_by_rating_group.png")
```
]
...
knitr::include_graphics("presentation_files/games_by_tier.png")
```
]
...
.footnote[Opening effectiveness varies significantly based on whether you're playing White or Black pieces.]
...
.pull-right[**Differential Analysis:** The **Pirc Defense** shows the strongest Black advantage at **-8% (White-Black)**, while **Queen's Gambit** favors White by **+22%**. The zero line represents perfect balance.
...
knitr::include_graphics("presentation_files/winrate_by_time_control_and_color.png")
```
]
