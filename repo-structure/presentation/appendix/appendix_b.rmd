...
if (nrow(rating_summary) == 0) {
    ...
    print(p1)
    ggsave("../../presentation/presentation_files/lichess-rating-progression-over-time.png", plot = p1, width = 10, height = 6, dpi = 300)
}
```
...
if (nrow(rating_summary) == 0) {
    ...
    p2 <- ggplot(volatility_stats, aes(x = category, y = sd_rating, fill = category)) +
    ...
    print(p2)
    ggsave("../../presentation/presentation_files/rating_volatility.png", plot = p2, width = 10, height = 6, dpi = 300)
}
```
...
if (nrow(rating_summary) == 0) {
    ...
    p3 <- ggplot(growth_models, aes(x = reorder(user, slope), y = slope, fill = r_squared)) +
        geom_col() +
    ...
    print(p3)
    ggsave("../../presentation/presentation_files/rating_growth.png", plot = p3, width = 10, height = 6, dpi = 300)
