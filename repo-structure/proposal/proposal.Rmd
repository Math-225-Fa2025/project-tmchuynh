...
Here’s a tight, practical set of methods for your proposal.
It’s split into **Statistical Tests** (inference you’ll report) and **Algorithms** (models/smoothers you’ll fit).
Choices map to your data: country–year panels of seizures, socioeconomic/governance covariates, regional wholesale price indices (lagged), live-trade shares, and snapshot context (populations, tourism anchors).
